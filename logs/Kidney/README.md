...
ASCT+B Validation Reports for Kidney (2022-11-29)
=================================================
...
1. In row _60_, the term _[UBERON:0001916](http://purl.obolibrary.org/obo/UBERON_0001916)_ has different name/label in the source ontology. The name/label in the ASCT+B table is _juxtaglomerular arteriole_ and the one in the ontology is _endothelium of arteriole_. For reference, the given name/label by SMEs is _Juxtaglomerular Arteriole_. Please correct it in the ASCT+B table.
...
[**Report**](../logs/Kidney/class_Kidney_log.tsv)
## Relationship CT-CT report
[**Report**](../logs/Kidney/class_Kidney_log.tsv)
## Relationship CT-AS report
[**Report**](../logs/Kidney/Kidney_AS__CT_strict_log.tsv)
# New CL terms
[**Report**](../logs/Kidney/new_cl_terms_Kidney.tsv)
# New UBERON terms
[**Report**](../logs/Kidney/new_uberon_terms_Kidney.tsv)
