...
ASCT+B Validation Reports for Blood_vasculature (2025-01-22)
============================================================
...
[*View image as PDF*](assets/ccf_Blood_vasculature_graph.pdf)

![Blood_vasculature ASCT+B table in graph](assets/ccf_Blood_vasculature_graph.png)