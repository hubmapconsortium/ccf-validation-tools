...
ASCT+B Validation Reports for Small_intestine (2023-11-22)
==========================================================
...
[*View image as PDF*](assets/ccf_Small_intestine_graph.pdf)

![Small_intestine ASCT+B table in graph](assets/ccf_Small_intestine_graph.png)