...
ASCT+B Validation Reports for Anatomical_Systems (2025-01-15)
=============================================================
...
[*View image as PDF*](assets/ccf_Anatomical_Systems_graph.pdf)

![Anatomical_Systems ASCT+B table in graph](assets/ccf_Anatomical_Systems_graph.png)