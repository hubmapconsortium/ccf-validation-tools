...
ASCT+B Validation Reports for Urinary_bladder (2023-08-10)
==========================================================
...
[*View image as PDF*](assets/ccf_Urinary_bladder_graph.pdf)

![Urinary_bladder ASCT+B table in graph](assets/ccf_Urinary_bladder_graph.png)