...
ASCT+B Validation Reports for Skeleton (2025-03-05)
===================================================
...
[*View image as PDF*](assets/ccf_Skeleton_graph.pdf)

![Skeleton ASCT+B table in graph](assets/ccf_Skeleton_graph.png)