...
ASCT+B Validation Reports for Large_intestine (2025-10-15)
==========================================================
...
[*View image as PDF*](assets/ccf_Large_intestine_graph.pdf)

![Large_intestine ASCT+B table in graph](assets/ccf_Large_intestine_graph.png)