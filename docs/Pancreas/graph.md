...
ASCT+B Validation Reports for Pancreas (2023-12-06)
===================================================
...
[*View image as PDF*](assets/ccf_Pancreas_graph.pdf)

![Pancreas ASCT+B table in graph](assets/ccf_Pancreas_graph.png)