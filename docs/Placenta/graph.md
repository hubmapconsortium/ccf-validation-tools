...
ASCT+B Validation Reports for Placenta (2025-01-22)
===================================================
...
[*View image as PDF*](assets/ccf_Placenta_graph.pdf)

![Placenta ASCT+B table in graph](assets/ccf_Placenta_graph.png)