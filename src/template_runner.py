...
class_template, no_valid_template, error_log, annotations, indirect_error_log, report_r, strict_log, has_part_log, ub_subs_t, cl_subs_t, image_report, sec_graph, cell_behavior_r = generate_class_graph_template(ccf_tools_df)
...
cell_behavior_r.to_csv(f'../logs/cell_behavior_{args.job}.tsv', sep='\t', index=False)
