...
class_template, no_valid_template, error_log, annotations, indirect_error_log, report_r, strict_log, unknown_terms, has_part_log, ub_subs_t, cl_subs_t, image_report, sec_graph, log_dict = generate_class_graph_template(ccf_tools_df, log_dict)
